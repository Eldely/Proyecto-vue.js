<template>
  <div id="home">
    ...
    <div class="lg:flex justify-between items-center mb-6">
      ...
      <button
        class="bg-blue-500 hover:bg-blue-600 focus:outline-none rounded-lg px-6 py-2 text-white font-semibold shadow">Ver
        registros</button>
    </div>
    ...
    <div class="flex flex-wrap -mx-3">
      ...
      <div class="w-full xl:w-1/3 px-3">
        <p class="text-xl font-semibold mb-4">Ventas recientes</p>
      ...
      <div class="w-full xl:w-1/3 px-3">
        <p class="text-xl font-semibold mb-4">Reseñas recientes</p>
      ...
      <div class="w-full xl:w-1/3 px-3">
        <p class="text-xl font-semibold mb-4">Transacciones recientes</p>
        <div class="w-full bg-white border rounded-lg p-4">
          <div class="w-full bg-gray-100 border rounded-lg flex justify-between items-center px-4 py-2 mb-4">
            ...
            <span class="text-green-500 font-semibold text-lg">$25.000</span>
          </div>
          ...
          <div class="w-full bg-gray-100 border rounded-lg flex justify-between items-center px-4 py-2 mb-4">
            ...
            <span class="text-red-500 font-semibold text-lg">$74.990</span>
          </div>
          ...
          <div class="w-full bg-gray-100 border rounded-lg flex justify-between items-center px-4 py-2 mb-4">
            ...
            <span class="text-green-500 font-semibold text-lg">$14.990</span>
          </div>
          ...
          <div class="w-full bg-gray-100 border rounded-lg flex justify-between items-center px-4 py-2">
            ...
            <span class="text-green-500 font-semibold text-lg">$44.990</span>
          </div>
        </div>
      </div>
