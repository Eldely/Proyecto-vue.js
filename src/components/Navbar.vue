<template>
    <div class="sticky top-0 z-40">
            <div class="w-full h-20 px-6 bg-gray-100 border-b flex items-center justify-between">
              ...
              <div class="flex">
                ...
                <div class="relative text-gray-600">
                  <input type="search" name="serch" placeholder="Buscar productos..." class="bg-white h-10 w-full xl:w-64 px-5 rounded-lg border text-sm focus:outline-none">
              ...
              <div class="flex items-center relative">
                ...
                <img src="https://cdn-icons-png.flaticon.com/512/6326/6326055.png" class="w-12 h-12 rounded-full shadow-lg" @click="dropDownOpen = !dropDownOpen">
              </div>
            ...
            <div class="absolute bg-gray-100 border border-t-0 shadow-xl text-gray-700 rounded-b-lg w-48 bottom-10 right-0 mr-6" :class="dropDownOpen ? '' : 'hidden'">
                ...
                <a href="#" class="block px-4 py-2 hover:bg-gray-200">Ajustes</a>
